...
public class MedicalRecordDao {
    ...
    // Phương thức Helper để lấy kết nối
    private Connection getConnection() throws SQLException {
        // Giữ logic lấy kết nối tại đây
    ...
    public boolean addMedicalRecord(MedicalRecords record) {
        String sql = "INSERT INTO MedicalRecords (patient_id, appointment_id, diagnosis, treatment, notes, created_at) " +
                "VALUES (?, ?, ?, ?, ?, ?)";
        // Sử dụng try-with-resources để đảm bảo Connection được đóng
        try (Connection conn = getConnection();
            ...
            ps.setInt(2, record.getAppointment_id() != null ? record.getAppointment_id().getAppointment_id() : 0);
