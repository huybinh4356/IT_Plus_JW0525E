        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover align-middle">
            ...
            <c:forEach var="clinic" items="${clinicList}">
              ...
              <div class="modal fade" id="detailModal${clinic.clinic_id}" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="detailModalLabel">Chi Tiết Phòng Khám: ${clinic.name}</h5>
