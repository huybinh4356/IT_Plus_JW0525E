...
<head>
  ...
  <title>Chi Tiết Dịch Vụ #${requestScope.currentServiceId}: Cấy ghép Implant Đơn lẻ</title>
  ...
  <style>
    ...
    .implant-stage { border-left: 3px solid #28a745; padding-left: 15px; margin-bottom: 25px; }
  </style>
</head>
<body>
...
<div class="detail-hero-section text-center">
  <div class="container-xl">
    <h1 class="detail-hero-title">CẤY GHÉP IMPLANT ĐƠN LẺ</h1>
    <p class="detail-hero-subtitle">Giải pháp phục hình răng mất vĩnh viễn, ngăn ngừa tiêu xương hàm</p>
    <a href="<c:url value='/guest-requests?action=addForm'/>" class="btn btn-booking">
      <i class="fas fa-calendar-alt me-2"></i> Tư vấn Implant ngay
    </a>
  </div>
</div>
    ...
    <div class="content-box">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb bg-light p-2 rounded-3">
          ...
          <li class="breadcrumb-item active" aria-current="page">Cấy ghép Implant</li>
        </ol>
      </nav>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          ...
          <h2 class="section-title">1. Ưu điểm của Implant</h2>
          <p>Implant là một trụ Titanium được cấy trực tiếp vào xương hàm tại vị trí răng bị mất, đóng vai trò như một chân răng nhân tạo.</p>

          <div class="row g-3 mb-4">
            <div class="col-md-6">
              <div class="card card-feature h-100">
                <div class="card-body d-flex align-items-start">
                  <i class="fas fa-magic feature-icon-large"></i>
                  <div>
                    <h5 class="card-title fw-bold text-dark">Khôi phục 100%</h5>
                    <p class="card-text text-muted">Chức năng ăn nhai và thẩm mỹ như răng thật.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card card-feature h-100">
                <div class="card-body d-flex align-items-start">
                  <i class="fas fa-bone feature-icon-large"></i>
                  <div>
                    <h5 class="card-title fw-bold text-dark">Ngăn ngừa tiêu xương</h5>
                    <p class="card-text text-muted">Giữ vững cấu trúc xương hàm, tránh lão hóa khuôn mặt.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <h2 class="section-title">2. Quy trình Cấy ghép Đạt chuẩn</h2>
          <div class="implant-stage">
            <h5 class="text-primary fw-bold"><i class="fas fa-search me-2"></i> Bước 1: Khám và Lập Kế hoạch</h5>
            <p class="text-muted">Chụp Cone Beam CT 3D để đánh giá chất lượng xương, xác định vị trí cấy trụ Implant.</p>
          </div>

          <div class="implant-stage">
            <h5 class="text-primary fw-bold"><i class="fas fa-syringe me-2"></i> Bước 2: Cấy trụ Implant</h5>
            <p class="text-muted">Tiến hành tiểu phẫu cấy trụ Implant vào xương hàm dưới điều kiện vô trùng tuyệt đối.</p>
          </div>

          <div class="implant-stage">
            <h5 class="text-primary fw-bold"><i class="fas fa-clock me-2"></i> Bước 3: Tích hợp xương (3-6 tháng)</h5>
            <p class="text-muted">Thời gian trụ Implant tích hợp với xương hàm (có thể cần ghép xương nếu thiếu).</p>
          </div>

          <div class="implant-stage">
            <h5 class="text-primary fw-bold"><i class="fas fa-teeth-open me-2"></i> Bước 4: Lắp Mão Sứ</h5>
            <p class="text-muted">Lắp Abutment và mão sứ lên trên, hoàn tất phục hình.</p>
          </div>

          <hr class="my-5">

          <h2 class="section-title">3. Chính sách & Vật liệu</h2>
          <div class="alert alert-success shadow-sm" role="alert">
            <h4 class="alert-heading text-success"><i class="fas fa-award me-2"></i> Bảo hành Trọn Đời!</h4>
            <p>Sử dụng Implant **Straumann (Thụy Sĩ)**. Khách hàng được bảo hành **trọn đời** đối với trụ Implant.</p>
          </div>
          ...
          <div class="card sidebar-card sticky-top" style="top: 20px;">
            ...
            <ul class="list-group list-group-flush mb-4">
              <li class="list-group-item d-flex justify-content-between bg-transparent">
                <strong>ID Dịch vụ:</strong> <span>#5</span>
              </li>
              <li class="list-group-item d-flex justify-content-between bg-transparent">
                <strong>Công nghệ:</strong> <span>Implant Straumann</span>
              </li>
              <li class="list-group-item d-flex justify-content-between bg-transparent">
                <strong>Thời gian:</strong> <span>3 - 6 tháng</span>
              </li>
              <li class="list-group-item d-flex justify-content-between bg-transparent">
                <strong>Chi phí ước tính:</strong> <span class="fw-bold text-danger">20.000.000 VNĐ</span>
              </li>
              <li class="list-group-item d-flex justify-content-between bg-transparent">
                <strong>Bảo hành trụ:</strong> <span class="fw-bold text-success">Trọn Đời</span>
              </li>
            </ul>
