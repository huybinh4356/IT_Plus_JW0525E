...
<div class="container mt-5">
    <div class="card-form col-md-10 mx-auto">
        ...
        <%-- Luôn đặt action là 'update' --%>
        <c:set var="formAction" value="${pageContext.request.contextPath}/users?action=update"/>

        <form method="post" action="${formAction}">

            <%-- BẮT BUỘC có ID khi sửa --%>
            <c:if test="${not empty user.user_id}">
                <input type="hidden" name="user_id" value="${user.user_id}"/>
            </c:if>
            <c:if test="${empty user.user_id}">
                <div class="alert alert-warning text-center">Lỗi: Không tìm thấy ID người dùng để chỉnh sửa.</div>
            </c:if>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <%-- Tên đăng nhập luôn là readonly khi sửa --%>
                    ...
                    <div class="mb-3">
                        ...
                        <%-- ĐÃ SỬA LỖI: Dùng ${user.dob} trực tiếp vì là java.time.LocalDate --%>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3 form-check d-flex align-items-center">
                        <%-- Mặc định là true khi sửa --%>
                        <c:set var="isActiveChecked" value="${user.is_active eq true}"/>
